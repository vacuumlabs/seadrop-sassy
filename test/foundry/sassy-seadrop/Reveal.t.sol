...
contract RevealNftTest is TestHelper {
    ...
    function setUp() public {
        ...
        nftContract.updatePublicDrop(address(seadrop),
        PublicDrop(
            mintPrice,
    ...
    function test_RevealFailsIfInvalidRarityInvalidTokenId() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(SassyShreddersErrorsAndEvents.InvalidRarity.selector, 12)
        );
    ...
    function test_RevealFailsIfAlreadyRevealed() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(SassyShreddersErrorsAndEvents.RarityAlreadyRevealed.selector, 1, 1)
        );
